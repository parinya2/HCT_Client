...
namespace HCT_Client
{
    public class LocalizedTextManager
    {
        ...
        private LocalizedTextManager()
        {
            ...
            SetDictValueForKey("ErrorMessageBox." + WebServiceResultStatus.ERROR_INVALID_PARAMETERS + ".Message", "ข้อมูลของท่านในฐานข้อมูลของโรงเรียนมีบางอย่างไม่ถูกต้อง กรุณาติดต่อเจ้าหน้าที่", "Some information is incorrect, please contact an officer.");           
            ...
            SetDictValueForKey("ErrorMessageBox." + WebServiceResultStatus.ERROR_CANNOT_CREATE_SSL_TLS_CHANNEL + ".Message", "ไม่สามารถเชื่อมต่อแบบ Secure Channel กับ server ได้ กรุณาติดต่อเจ้าหน้าที่", "Could not create SSL/TLS secure channel, please contact an officer.");
